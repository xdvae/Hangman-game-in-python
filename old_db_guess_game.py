...
def start():
    ...
    word_chosen = Words[random_number].get('name')  # Picks random word at a random index.
    ...
    while(tries > 0):       # Starts the loop.
        ...
        if(hint_1 == True):
            print("Hint 1: "+str(Words[random_number].get('hint_1')))
        if(hint_2 == True):
            print("Hint 2: "+str(Words[random_number].get('hint_2')))
        if(hint_3 == True):
            print("Hint 3: "+str(Words[random_number].get('hint_3')))
        
        # Managing player input and matching the answer below.
        player_input = input("> ")
        player_input = player_input.lower()
        player_input = player_input.capitalize() # The old data i had has the letters capitalised so keeping this here
