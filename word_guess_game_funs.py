...
def start():
    ...
    os.system("cls")
    random_index = random.randint(0,102)
    ...
    def hint_1():
        ...
        while next_hint_in > 0:
            ...
            if(player_input == chosen_word):
                win_or_loose = True
                gameover(win_or_loose)
                break
            
            elif(player_input != chosen_word):
                tries -=1
                next_hint_in -=1
                #i am pausing to see how to implement the get right words things
                #TODO: add a methods that shows the right words and where they are used
